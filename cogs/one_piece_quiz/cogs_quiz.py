...
class quize(commands.Cog):
    ...
    @discord.app_commands.command(name="quiz_one_piece",description="permet de participer à un quiz")
    ...
    @discord.app_commands.command(name="soluce_one_piece",description="permet de répondre au quiz")
